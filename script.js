...
toggler(".navbar-search", ".search-overlay", ".close-overlay", "hide-overlay");

toggler(".navbar-toggler", ".under-nav", ".close-nav-overlay", "hide-overlay-nav");
...
const formPlaceholder = document.querySelector('.inner-search form div input[type="text"]');
formPlaceholder.placeholder = "Search";
